...
const globalEventLocations = {
  ...
  italy: { country: "Italia", continent: "Europa", cities: ["Rome", "Milan", "Turin", "Florence", "Bologna", "Naples", "Venice"] },
  austria: { country: "Austria", continent: "Europa", cities: ["Vienna", "Graz", "Linz", "Salzburg", "Innsbruck"] },
  luxembourg: { country: "Luxembourg", continent: "Europa", cities: ["Luxembourg City"] },
  netherlands: { country: "Holanda", continent: "Europa", cities: ["Amsterdam", "Rotterdam", "The Hague", "Utrecht", "Eindhoven"] },
  denmark: { country: "Dinamarca", continent: "Europa", cities: ["Copenhagen", "Aarhus", "Odense", "Aalborg"] },
  sweden: { country: "Suecia", continent: "Europa", cities: ["Stockholm", "Gothenburg", "Malmo", "Uppsala"] },
  norway: { country: "Noruega", continent: "Europa", cities: ["Oslo", "Bergen", "Trondheim", "Stavanger"] },
  malaysia: { country: "🇲🇾 Malásia", continent: "Ásia", cities: ["Kuala Lumpur", "Penang", "Johor Bahru", "Kota Kinabalu", "Melaka", "Kuching"] },
  hongKong: { country: "Hong Kong", continent: "Asia", cities: ["Hong Kong"] },
  taiwan: { country: "Taiwan", continent: "Asia", cities: ["Taipei", "Taichung", "Kaohsiung", "Tainan"] },
  ...
  iran: { country: "Iran", continent: "Asia", cities: ["Tehran", "Mashhad", "Isfahan", "Shiraz", "Tabriz", "Karaj", "Qom"] },
  afghanistan: { country: "Afghanistan", continent: "Asia", cities: ["Kabul", "Herat", "Kandahar", "Mazar-i-Sharif"] },
  tajikistan: { country: "Tajikistan", continent: "Asia", cities: ["Dushanbe", "Khujand", "Kulob", "Bokhtar"] },
  oman: { country: "Oman", continent: "Middle East", cities: ["Muscat", "Salalah", "Sohar", "Nizwa"] },
  poland: { country: "Polonia", continent: "Europa", cities: ["Warsaw", "Krakow", "Wroclaw", "Gdansk", "Poznan", "Lodz", "Katowice"] },
  czechRepublic: { country: "Republica Tcheca", continent: "Europa", cities: ["Prague", "Brno", "Ostrava", "Plzen"] },
  slovakia: { country: "Eslovaquia", continent: "Europa", cities: ["Bratislava", "Kosice", "Nitra", "Zilina"] },
  hungary: { country: "Hungria", continent: "Europa", cities: ["Budapest", "Debrecen", "Szeged", "Miskolc"] },
  romania: { country: "Romenia", continent: "Europa", cities: ["Bucharest", "Cluj-Napoca", "Timisoara", "Iasi"] },
  lithuania: { country: "Lituania", continent: "Europa", cities: ["Vilnius", "Kaunas", "Klaipeda"] },
  latvia: { country: "Letonia", continent: "Europa", cities: ["Riga", "Daugavpils", "Liepaja"] },
  estonia: { country: "Estonia", continent: "Europa", cities: ["Tallinn", "Tartu", "Narva"] },
  philippines: { country: "Filipinas", continent: "Asia", cities: ["Manila", "Quezon City", "Makati", "Cebu", "Davao", "Taguig"] },
...
const countryNameByKey: Record<CountryKey, string> = {
  ...
  oman: "Oma",
  poland: "Polonia",
  czechRepublic: "Republica Tcheca",
  slovakia: "Eslovaquia",
  hungary: "Hungria",
  romania: "Romenia",
  lithuania: "Lituania",
...
const countryGroupLabelsByLocale: Record<Locale, { primary: string; other: string }> = {
  ...
  it: { primary: "Paesi principali", other: "Altri paesi" },
  de: { primary: "Hauptlaender", other: "Weitere Laender" },
  ...
  zh: { primary: "\u4E3B\u8981\u56FD\u5BB6\u548C\u5730\u533A", other: "\u5176\u4ED6\u56FD\u5BB6" },
  fa: { primary: "\u06a9\u0634\u0648\u0631\u0647\u0627\u06cc \u0627\u0635\u0644\u06cc", other: "\u06a9\u0634\u0648\u0631\u0647\u0627\u06cc \u062f\u06cc\u06af\u0631" },
  pl: { primary: "Glowne kraje", other: "Inne kraje" },
  tl: { primary: "Pangunahing bansa", other: "Ibang bansa" },
};
...
const primaryCountryKeysByLocale: Record<Locale, CountryKey[]> = {
  ...
  ja: ["japan"],
  ko: ["southKorea"],
  zh: ["singapore", "hongKong", "taiwan", "malaysia"],
...
const preferredOtherCountryKeysByLocale: Record<Locale, CountryKey[]> = {
  ...
  it: ["austria", "germany", "france", "spain", "portugal", "unitedKingdom", "unitedStates", "brazil"],
  de: ["luxembourg", "belgium", "netherlands", "denmark", "sweden", "norway", "unitedKingdom", "unitedStates"],
  ...
  zh: ["japan", "southKorea", "thailand", "indonesia", "vietnam", "australia", "canada", "unitedStates"],
  fa: ["uae", "turkey", "qatar", "kuwait", "oman", "bahrain", "saudiArabia"],
  pl: ["czechRepublic", "slovakia", "hungary", "romania", "lithuania", "latvia", "estonia", "germany", "unitedKingdom", "unitedStates"],
  tl: ["singapore", "malaysia", "indonesia", "thailand", "vietnam", "hongKong", "japan", "southKorea", "australia", "unitedStates"],
};
