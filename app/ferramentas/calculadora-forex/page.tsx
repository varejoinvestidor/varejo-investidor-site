...
const copyByLocale: Partial<Record<Locale, ToolCopy>> = {
  ...
  es: {
    ...
    h1: "Calculadora Forex",
    h2: "Calcula riesgo, lote correcto, impacto por pip, metas y conversión de moneda en una sola herramienta.",
    formTitle: "Datos de la operación",
    freeButton: "Entrar al Canal Formiga",
    signalsButton: "Recibir señales en WhatsApp",
  },
  fr: { ...enCopy, lang: "fr", eyebrow: "Outil Forex", h1: "Calculateur Forex", freeButton: "Entrer dans le Canal Formiga" },
  hi: { ...enCopy, lang: "hi", eyebrow: "Forex टूल", h1: "Forex Calculator", freeButton: "Formiga Channel में प्रवेश करें" },
  ar: { ...enCopy, lang: "ar", eyebrow: "أداة الفوركس", h1: "حاسبة الفوركس", freeButton: "الدخول إلى قناة Formiga" },
  tr: { ...enCopy, lang: "tr", eyebrow: "Forex Aracı", h1: "Forex Hesaplayıcı", freeButton: "Formiga Kanalına Gir" },
  id: { ...enCopy, lang: "id", eyebrow: "Alat Forex", h1: "Kalkulator Forex", freeButton: "Masuk ke Kanal Formiga" },
  vi: { ...enCopy, lang: "vi", eyebrow: "Công cụ Forex", h1: "Máy tính Forex", freeButton: "Vào Kênh Formiga" },
  th: { ...enCopy, lang: "th", eyebrow: "เครื่องมือ Forex", h1: "เครื่องคำนวณ Forex", freeButton: "เข้าสู่ช่อง Formiga" },
  ru: { ...enCopy, lang: "ru", eyebrow: "Инструмент Forex", h1: "Калькулятор Forex", freeButton: "Войти в канал Formiga" },
  ur: { ...enCopy, lang: "ur", eyebrow: "Forex ٹول", h1: "Forex Calculator", freeButton: "Formiga Channel میں داخل ہوں" },
  bn: { ...enCopy, lang: "bn", eyebrow: "Forex টুল", h1: "Forex Calculator", freeButton: "Formiga Channel এ প্রবেশ করুন" },
  ja: { ...enCopy, lang: "ja", eyebrow: "Forexツール", h1: "Forex計算機", freeButton: "Formigaチャンネルに入る" },
  ko: { ...enCopy, lang: "ko", eyebrow: "Forex 도구", h1: "Forex 계산기", freeButton: "Formiga 채널 입장" },
};
