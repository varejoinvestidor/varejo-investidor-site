...
const homeLiteCopy = {
  ...
  hi: {
    ...
    intro: {
      ...
      manifesto:
        "Varejo Investidor उन लोगों के लिए एक वैश्विक वित्तीय संरचना है जो बुनियादी स्तर से आगे बढ़कर अंतरराष्ट्रीय बाजार को समझना और अपनी वित्तीय जिंदगी को परतों में बनाना चाहते हैं.",
      text: [
        "2018 से हमने Forex, सोना, तेल, क्रिप्टो, इंडेक्स और वैश्विक मुद्राओं को ट्रैक करते हुए 4,200 से अधिक लाइव सिग्नल दिए हैं.",
        "यह यात्रा तीन स्तरों में विभाजित है: Formiga, Lobo और Harpia.",
        "Formiga आधार बनाता है. Lobo रणनीति और बाजार-पठन विकसित करता है. Harpia संपत्ति, सुरक्षा और वैश्विक संरचना की दृष्टि को विस्तृत करता है.",
      ],
      stats: ["2018 से", "लाइव सिग्नल", "Formiga / Lobo / Harpia"],
    },
    cards: [
      { code: "FORMIGA", title: "वित्तीय आधार", text: "आधार बनाने, जोखिम व्यवस्थित करने और शुरुआती वित्तीय स्तंभ तैयार करने की चरणबद्ध शिक्षा.", href: "/educacao" },
      { code: "LOBO", title: "रणनीति और विस्तार", text: "लाइव सिग्नल, बाजार-पठन और अनुशासित संचालन के लिए संरचित निर्णय.", href: "/sinais" },
      { code: "HARPIA", title: "वैश्विक संपत्ति", text: "सुरक्षा, पोजिशनिंग, संपत्ति और अंतरराष्ट्रीय दृष्टि के लिए रणनीतिक परामर्श.", href: "/servicos" },
    ],
    cardCta: "और जानें",
    final: {
      title: "निःशुल्क शुरुआत करें और अपना अगला स्तर चुनें.",
      free: "निःशुल्क चैनल में प्रवेश करें",
...
export default function Home() {
  ...
  return (
    <main lang={locale === "hi" ?"hi" : undefined} className="min-h-screen overflow-hidden bg-paper text-ink">
      ...
      <section id="home" className="home-hero premium-stage relative px-5 pb-20 pt-36 md:px-8 md:pb-28 md:pt-48">
      ...
      <section className="border-y border-ink/[0.08] bg-white/90 px-5 py-20 md:px-8 md:py-24">
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-80px" }} transition={{ duration: 0.55, ease: [0.22, 1, 0.36, 1] }} variants={fadeUp} className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.58fr_1fr] lg:items-start">
          <div>
      ...
      <section className="px-5 py-20 md:px-8 md:py-24">
        <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.55 }} className="relative mx-auto max-w-7xl overflow-hidden border border-ink bg-ink px-6 py-16 text-center text-paper shadow-premium md:px-12 md:py-24">
