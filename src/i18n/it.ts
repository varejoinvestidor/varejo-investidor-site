export const it = {
  ...
  nav: {
    ...
    services: "Servizi",
    about: "Chi siamo",
    access: "Entra nel Canale Elite",
  },
  tickerLabel: "Mercati globali",
  hero: {
    eyebrow: "Varejo Investidor | Dal 2018",
    title: "Tutto ciò che ti serve per investire e costruire patrimonio a livello globale.",
    text: "Comprendi i mercati globali, segui analisi economiche e sviluppa una strategia per costruire patrimonio oltre i confini del tuo Paese.",
    primary: "Entra nel Canale Formiga",
  ...
  freeChannel: {
    title: "Canale Formiga gratuito",
    text: "Ricevi gratuitamente analisi economiche, contenuti educativi e aggiornamenti sui mercati globali direttamente su WhatsApp.",
    button: "ENTRA NEL CANALE FORMIGA",
    link: "https://whatsapp.com/channel/0029VbBtwwfCXC3HTPFmzo0q",
    eyebrow: "Ingresso gratuito",
  },
  signalBlock: {
    eyebrow: "Analisi e segnali dal 2018",
    title: "Ricevi analisi e segnali direttamente su WhatsApp.",
    text: "Lascia l'analisi a noi. Ricevi segnali su WhatsApp con ingresso, obiettivo e stop definiti. Copi le informazioni e operi dal tuo conto.",
    cta: "PROVA I SEGNALI GRATIS",
    stats: ["8 anni di mercato", "Dal 2018", "+4.200 segnali inviati", "Forex, oro, petrolio, crypto, indici e valute globali"],
    example: {
