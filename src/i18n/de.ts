export const de = {
  ...
  nav: {
    ...
    services: "Services",
    about: "Ueber uns",
    access: "Elite Channel beitreten",
  },
  tickerLabel: "Globale Maerkte",
  hero: {
    eyebrow: "Varejo Investidor | Seit 2018",
    title: "Alles, was du brauchst, um global zu investieren und Vermoegen aufzubauen.",
    text: "Verstehe globale Maerkte, verfolge Wirtschaftsanalysen und entwickle eine Strategie, um Vermoegen ueber Landesgrenzen hinaus aufzubauen.",
    primary: "In den Formiga-Kanal eintreten",
  ...
  freeChannel: {
    ...
    text: "Erhalte kostenlose Wirtschaftsanalysen, Bildungsinhalte und Updates zu globalen Maerkten direkt auf WhatsApp.",
    button: "IN DEN FORMIGA-KANAL",
    link: "https://whatsapp.com/channel/0029VbBtwwfCXC3HTPFmzo0q",
    eyebrow: "Kostenloser Einstieg",
  },
  signalBlock: {
    eyebrow: "Analysen und Signale seit 2018",
    title: "Erhalte Analysen und Handelssignale direkt auf WhatsApp.",
    text: "Wir uebernehmen die Analyse. Du erhaeltst Signale mit Einstieg, Ziel und Stop direkt auf WhatsApp und fuehrst sie in deinem eigenen Konto aus.",
    cta: "SIGNALE KOSTENLOS TESTEN",
    stats: ["8 Jahre am Markt", "Seit 2018", "+4.200 Live-Signale", "Forex, Gold, Oel, Krypto, Indizes und globale Waehrungen"],
    example: {
