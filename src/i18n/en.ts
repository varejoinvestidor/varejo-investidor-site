export const en = {
  ...
  nav: {
    ...
    services: "Services",
    about: "About",
    access: "Join Elite Channel",
  },
  tickerLabel: "Global Market Tape",
  hero: {
    eyebrow: "Varejo Investidor | Since 2018",
    title: "Receive market signals ready to copy and paste into your account.",
    text: "Elite Channel delivers live signals, analysis, and education for forex, gold, oil, crypto, indices, and global currencies with clarity and discipline.",
    primary: "Join Elite Channel",
    secondary: "See signal example",
    proof: [
