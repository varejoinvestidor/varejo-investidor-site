export const pl = {
  ...
  nav: {
    ...
    "services": "Us?ugi",
    "about": "O nas",
    "access": "Do??cz do kana?u Elite"
  },
  tickerLabel: "Ta?ma rynk?w globalnych",
  hero: {
    "eyebrow": "Varejo Investidor | Od 2018",
    "title": "Wszystko, czego potrzebujesz, aby inwestowa? i budowa? maj?tek na poziomie globalnym.",
    "text": "Zrozum globalne rynki, ?led? analizy ekonomiczne i rozwijaj strategi? budowania maj?tku poza granicami swojego kraju.",
    "primary": "Wejd? do Kana?u Formiga",
    "secondary": "Poznaj nasze us?ugi",
    "proof": [
      [
        "8 lat",
      ...
      [
        "+4 200",
        "wys?anych sygna??w live"
      ],
      [
        "Globalnie",
        "Forex, z?oto, ropa, krypto i indeksy"
      ]
    ]
  },
  freeChannel: {
    "title": "Bezp?atny Kana? Formiga",
    "text": "Otrzymuj bezp?atne analizy ekonomiczne, materia?y edukacyjne i aktualizacje globalnych rynk?w bezpo?rednio na WhatsApp.",
    "button": "WEJD? DO KANA?U FORMIGA",
    "eyebrow": "Bezp?atny start",
    "link": "https://whatsapp.com/channel/0029VbBtwwfCXC3HTPFmzo0q"
  },
  signalBlock: {
    eyebrow: "Analizy i sygna?y od 2018",
    title: "Otrzymuj analizy i sygna?y bezpo?rednio na WhatsApp.",
    text: "Analiz? zostaw nam. Otrzymujesz na WhatsApp sygna?y z okre?lonym wej?ciem, celem i stopem, a transakcj? wykonujesz na w?asnym rachunku.",
    cta: "PRZETESTUJ SYGNA?Y ZA DARMO",
    stats: ["8 lat na rynku","Od 2018","+4 200 sygna??w live","Forex, z?oto, ropa, krypto, indeksy i waluty globalne"],
    example: {
