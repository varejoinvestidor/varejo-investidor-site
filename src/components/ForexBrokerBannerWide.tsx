...
export function ForexBrokerBannerWide({ language }: { language: Locale }) {
  ...
  const ctaMap = {
    ...
    th: { before: "เปิดบัญชีและ", highlight: "เริ่มเทรด", after: "วันนี้", second: "คลิกที่แบนเนอร์" },
    ru: { before: "Откройте счет и ", highlight: "начните торговать", after: " сегодня.", second: "Нажмите на баннер." },
    ur: { before: "اکاؤنٹ کھولیں اور ", highlight: "ٹریڈنگ شروع کریں", after: " آج ہی۔", second: "بینر پر کلک کریں۔" },
    bn: { before: "অ্যাকাউন্ট খুলুন এবং ", highlight: "ট্রেডিং শুরু করুন", after: " আজই।", second: "ব্যানারে ক্লিক করুন।" },
